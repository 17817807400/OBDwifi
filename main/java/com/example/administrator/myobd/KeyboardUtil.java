...
/**
 * Created by DWF on 2019/8/30.
 */

public class KeyboardUtil {
    boolean checkedkeyborad=false;
    ...
    public  KeyboardUtil(Activity activity, EditText edit) {
        ...
        numberKeyboard = new Keyboard(activity, R.xml.keyboard_province);
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (primaryCode == -1) {// 省份简称与数字键盘切换
                //if (mEdit.getText().toString().matches(reg)) {
                    changeKeyboard(!checkedkeyborad);
                    checkedkeyborad=!checkedkeyborad;
               // }
